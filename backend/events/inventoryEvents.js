 ...
 */
inventoryEvents.on('inventory_finalized', async ({ slip, userId, session }) => {
    try {
        ...
        // Note: In a production app, you might want to use a reliable queue (BullMQ/RabbitMQ) 
        // to ensure these background tasks eventually succeed if they fail here.
    }
});
