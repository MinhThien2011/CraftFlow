  ...
  return (
    <AppShell title="Vị trí kho nguyên liệu" subtitle="Quản lý kệ và vị trí lưu trữ nguyên vật liệu">
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-lg font-semibold">Sơ đồ kệ kho nguyên liệu</CardTitle>
          </CardHeader>
          <CardContent>
            {isLoading ? (
                                  ...
                                  <HoverCard>
                                    ...
                                    <HoverCardContent className="w-80">
                                      <div className="space-y-2">
                                        <h4 className="text-sm font-semibold">Vật tư đang lưu trữ</h4>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              {editingShelf ? 'Chỉnh sửa thông tin vị trí lưu trữ' : 'Tạo vị trí lưu trữ mới cho nguyên vật liệu'}
            </DialogDescription>
          </DialogHeader>
          <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Ví dụ: A1-01" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Kệ nguyên liệu nhựa..." {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
