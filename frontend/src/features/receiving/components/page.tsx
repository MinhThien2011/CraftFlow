...
import { MapPin, Plus, Edit2, Package, Maximize2, Trash2, Search, Loader2 } from 'lucide-react'
...
export default function ProductLocationsPage() {
    ...
    // Gọi API lấy danh sách kệ dành cho THÀNH PHẨM (Product)
    ...
    const form = useForm<ShelfFormData>({
        ...
        defaultValues: {
            shelfCode: '',
            warehouseSection: '',
            category: 'Product', // Mặc định là Product
            maxCapacity: 1000,
            status: 'Available',
            description: '',
        },
    ...
    return (
        <AppShell title="Vị trí kho thành phẩm" subtitle="Quản lý kệ và vị trí lưu trữ thành phẩm">
                                                                    ...
                                                                    <HoverCard>
                                                                        <HoverCardTrigger asChild>
                                                                            <Badge variant="outline" className="text-[10px] px-1 h-4 cursor-help">
                                                                                {location.items.length} mặt hàng
                                                                            </Badge>
                                                                        </HoverCardTrigger>
                                                                        <HoverCardContent className="w-80">
                                                                            <div className="space-y-2">
                                                                                ...
                                                                                <div className="max-h-[200px] overflow-auto space-y-2">
                                                                                    {location.items.map((item: any, idx: number) => (
            ...
            {/* Phần form thêm sửa/xoá tương tự được giữ nguyên, chỉ thay text thành 'thành phẩm' */}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input placeholder="Kệ thành phẩm..." {...field} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
