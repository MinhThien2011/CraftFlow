    ...
    <div className="relative overflow-hidden rounded-[2rem] border border-white/40 dark:border-white/10 bg-gradient-to-br from-card/85 to-card/35 backdrop-blur-3xl shadow-sm transition-all hover:shadow-lg flex flex-col">
      ...
      <div className="flex items-center justify-between border-b border-border/50 p-6 sm:p-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-base sm:text-lg font-bold text-foreground">Tiến độ đơn sản xuất gần đây</h3>
            <p className="text-xs text-muted-foreground">Theo dõi thời gian thực tiến độ hoàn thành các đơn lệnh</p>
          </div>
        </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border/40 bg-muted/20">
              <th className="px-6 py-4 text-left text-xs font-bold uppercase tracking-wider text-muted-foreground">Mã đơn</th>
